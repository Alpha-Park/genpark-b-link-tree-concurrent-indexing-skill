# genpark-b-link-tree-concurrent-indexing-skill

[![Agentic Skill](https://img.shields.io/badge/GenPark-Agentic__Skill-blue.svg)](https://github.com/Alpha-Park/genpark-b-link-tree-concurrent-indexing-skill)
...
> Lehman-Yao B-link tree concurrent index enabling lock-free read operations across dynamic node splits with high-key right links.
...
flowchart TD
    ...
    B --> C[genpark-b-link-tree-concurrent-indexing-skill Engine]
